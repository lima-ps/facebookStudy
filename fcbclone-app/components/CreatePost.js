...
const CreatePost = () => {
  ...
  const handleSubmit = (e) => {
    ...
    /* função que add a imagem nova a ser postada */
  const addImageToPost = (e) => {
   ...
   /* função que exclui a imagem nova a ser postada */
  const removeImage = () => {
    setImageToPost(null);
  };
  ...
  return (
    <div className="bg-white rounded-md shadow-md text-gray-500 p-2 divide-y">
      ...
      {/* se a imagem para postar existir entra aqui */}
      {imageToPost && (
        <div
          onClick={removeImage}
      ...
      <div className="flex justify-evenly py-2">
        ...
        <div
          ...
          <input
            /* isso vai gerar uma caixa para escolher um arquivo de imagem */
            ref={hiddenFileInput} 
